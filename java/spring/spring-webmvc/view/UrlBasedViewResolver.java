...
public class UrlBasedViewResolver extends AbstractCachingViewResolver implements Ordered {
	...
	private Class<?> viewClass;//根据这个生成具体的View实例

	private String prefix = "";

	private String suffix = "";

	private String contentType;//返回视图的类型,例如html,XML等
	...
	private final Map<String, Object> staticAttributes = new HashMap<String, Object>();//暂时没弄明白什么东东

	private Boolean exposePathVariables;

	private String[] viewNames;

	private int order = Integer.MAX_VALUE;//默认最大优先级
	...
	protected AbstractUrlBasedView buildView(String viewName) throws Exception {
		...
		//设置视图的full URL,也就是视图的全文件路径,例如/WEB-INF/view/index.js
